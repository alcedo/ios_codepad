...
//
//  Created by Victor Liew on 4/1/15.
//  Copyright (c) 2015 Victor Liew. All rights reserved.
//

import UIKit

class SampleTableViewController: UITableViewController, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.dataSource = ["Apple", "Orange", "Pear", "Water Melon"] + [String](count: 3000, repeatedValue: "Repeated")
    }
